"""
Run:
python datagenkit/pools_gather/gather_card.py
"""
...
INPUT_JSONL = REPO_ROOT / "datagenkit" / "outputs" / "gt_fix" / "card_step2_flow_122b" / "card_step2.jsonl"
OUTPUT_DIR = REPO_ROOT / "gt_optimization" / "gt_refine_20260415"
QUERY2IMAGES_PATH = OUTPUT_DIR / "card_query2images.jsonl"
IMAGE2QUERIES_PATH = OUTPUT_DIR / "card_image2queries.jsonl"
...
def load_query_results(record: dict) -> dict:
    ...
    step2_results = ((record.get("outputs") or {}).get("step2") or {}).get("results")
